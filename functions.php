...
require_once BH_THEME_DIR . '/inc/page-settings.php';
require_once BH_THEME_DIR . '/inc/contact-settings.php';
...
require_once BH_THEME_DIR . '/inc/yabe-webfont-bridge.php';
